        ...
        function Renderer(opts) {
            ...
            function createEmitterBuffers(emitter, transform) {
                ...
                if (len) {
                    ...
                    _gl.bindBuffer(ARRAY_BUFFER, emitter._webglVertexBuffer);
                    ...
                    _gl.bindBuffer(ARRAY_BUFFER, emitter._webglParticleBuffer);
            ...
            Shader.prototype.bind = function(obj, material, transform, camera, lights, ambient) {
                ...
                if (uniforms.particleSizeRatio) uniforms.particleSizeRatio.set(_viewportWidth > _viewportHeight ? _viewportHeight : _viewportWidth);
            ...
            function buildShader(shader) {
                ...
                if (emitter) {
                    vertexHeader += "uniform float particleSizeRatio;\n" + ShaderChunks.particle_header;
