    ...
    function(EventEmitter, Device, Dom, util, Mathf, Color, Vec2, Vec4, Mat4, Enums, Log, Canvas) {
        ...
        function Renderer(opts) {
            ...
            function renderSprite(camera, transform2d, sprite2d) {
                ...
                setUniformMatrix4fv(force, uniforms.matrix.location, MAT4, "matrix");
                setUniform4f(force, uniforms.crop.location, VEC4.set(sprite2d.x * w, sprite2d.y * h, sprite2d.w * w, sprite2d.h * h), "crop");
                setUniform2f(force, uniforms.size.location, VEC2.set(sprite2d.width, sprite2d.height), "size");
                setUniform1f(force, uniforms.alpha.location, sprite2d.alpha, "alpha");

                setTexture(force, uniforms.texture.location, texture, "texture");
