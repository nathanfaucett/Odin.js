    ...
    function(EventEmitter, Device, Dom, util, Mathf, Color, Vec3, Mat4, Enums, Log, Emitter, ShaderChunks, Canvas) {
        ...
        function Renderer(opts) {
            ...
            function initProgram(vertexShader, fragmentShader, parameters) {
                ...
                parseUniformsAttributes(webglProgram, glVertexShader, glFragmentShader, program.attributes, program.uniforms);
            ...
            function bindMaterial(material, transform, camera, lights, ambient) {
                ...
                if (uniforms.cameraPosition) uniforms.cameraPosition.bind(VEC3.positionFromMat4(camera.transform.matrixWorld));
                ...
                if (parameters.useLights && (length = lights.length)) {
                    ...
                    for (i = 0; i < length; i++) {
                        ...
                        if (pointLightColor.length && type === LightType.Point) {
                            ...
                            pointLightColor[pointLights].bind(COLOR);
                            pointLightPosition[pointLights].bind(VEC3);
                            ...
                            directionalLightColor[directionalLights].bind(COLOR);
                            directionalLightDirection[directionalLights].bind(VEC3);
                            directionalLights++;
                            ...
                            spotLightColor[spotLights].bind(COLOR);
                            spotLightPosition[spotLights].bind(VEC3);
                            spotLightDirection[spotLights].bind(VEC3_2);
                            ...
                            hemiLightColor[hemiLights].bind(COLOR);
                            hemiLightDirection[hemiLights].bind(VEC3);
                            hemiLights++;
                        }
                    }
                }
            ...
            function getUniformsAttributes(vertexShader, fragmentShader, attributes, uniforms) {
            ...
            Uniform4f.prototype.bind = function(value) {
                if (this.value.notEquals(value)) {
                    _gl.uniform4f(this.location, value.x, value.y, value.z);
                    this.value.copy(value);
                }
            };
