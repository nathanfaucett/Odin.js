    ...
    function(Device, io, Time, Mathf, Config, BaseGame, Log, Canvas, CanvasRenderer2D, WebGLRenderer2D, GameObject, Component, Scene, Input, Handler, Assets, AssetLoader) {
        ...
        ClientGame.prototype.setScene = function(scene) {
            ...
            if (!(scene instanceof Scene)) {
                Log.error("ClientGame.setScene: can't add passed argument, it is not an instance of Scene");
                return this;
            }
            ...
            if (index !== -1) {
                ...
                Log.error("ClientGame.setScene: Scene is not a member of ClientGame");
            }
        ...
        ClientGame.prototype.setCamera = function(gameObject) {
            ...
            if (!scene) {
                Log.error("ClientGame.setCamera: can't set camera without an active scene, use ClientGame.setScene first");
                return this;
            }
            ...
            if (this.camera) {
                ...
                Log.error("ClientGame.setCamera: GameObject does't have a Camera or a Camera2D Component");
            }
        ...
        ClientGame.prototype.updateRenderer = function() {
            ...
            if (!camera) {
                Log.error("ClientGame: can't set Renderer without a Camera");
                return;
            }
            ...
            if (typeof(this.customRenderer) === "function") {
                ...
                Log.log("ClientGame: setting up custom renderer " + this.customRenderer.name);
            } else {
                if (gameObject.camera) {
                    Log.warn("ClientGame.updateRenderer: no renderer for camera component yet");
                    ...
                    if (!Config.forceCanvas && Device.webgl) {
                        ...
                        Log.log("ClientGame: setting up WebGLRenderer2D");
                        ...
                        Log.log("ClientGame: setting up CanvasRenderer2D");
                    } else {
                        Log.error("ClientGame.updateRenderer: Could not get a renderer for this device");
                    }
                }
            }
